...
impl Database {
    ...
    fn insert_address(&mut self, new_address: &Address) {
    ...
    fn insert_document(&mut self, new_doc: &Document) {
    ...
    pub fn insert_person(&mut self, new_person: &mut CreatePerson) {
        ...
        let inserted_record = diesel::insert_into(person)
            ...
            .get_result::<Person>(&mut self.connection)
    ...
    pub fn get_persons(&mut self) -> Vec<(Person, Address, Document)> {
        ...
        person
            ...
            .load::<(Person, Address, Document)>(&mut self.connection)
            .unwrap()
    }

    pub fn get_person_by_id(&mut self, p_id: i32) -> (Person, Address, Document) {
        ...
        person
            ...
            .get_result::<(Person, Address, Document)>(&mut self.connection)
            .unwrap()
    }
}
